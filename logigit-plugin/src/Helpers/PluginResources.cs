namespace Loupedeck.LogiGitPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LogiGitPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LogiGitPlugin.Resources.Resource.txt`.
